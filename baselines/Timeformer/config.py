...
from basicts.metrics import masked_mae, masked_mse,masked_mape
from basicts.data import TimeSeriesForecastingDataset
from basicts.runners import SimpleTimeSeriesForecastingRunner
from basicts.scaler import ZScoreScaler
from basicts.utils import get_regular_settings

from .arch import Timeformer

############################## Hot Parameters ##############################
# Dataset & Metrics configuration
DATA_NAME = 'ship30_10'  # Dataset name
...
MODEL_PARAM = {
    ...
    "factor": 3, #    3   attn factor       #3000-1000:3
    "p_hidden_dims": [128, 128],   #128       #3000-1000:128
    "p_hidden_layers": 2,
    "d_model":  512,  #512                 #3000-1000:256
    "moving_avg": 25,   #25                  #3000-1000:25       # window size of moving average. This is a CRUCIAL hyper-parameter.
    "n_heads": 8,
