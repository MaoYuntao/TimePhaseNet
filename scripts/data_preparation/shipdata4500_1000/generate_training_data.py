...
# Hyperparameters
dataset_name = 'ship4500_1000'
data_file_path = f'../../../datasets/{dataset_name}.csv'
graph_file_path = None
output_dir = f'../../../datasets/{dataset_name}'
target_channel =[0]# Target traffic flow channel
domain = 'High navigation'
...
steps_per_day = 8640000    # Number of time steps per day
frequency = 1440 // steps_per_day #得到每个时间步的
domain = 'High Navigation'
regular_settings = {
    'INPUT_LEN': 4500,
    'OUTPUT_LEN': 1000,
...
def load_and_preprocess_data():
    ...
    df = pd.read_csv(data_file_path,encoding="GBK")
...
def add_temporal_features(data, df):
    ...
    print(data_with_features[0:2])
    print(data_with_features[0:2].shape)
